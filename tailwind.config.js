  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "anime-primary":
          "linear-gradient(135deg, #ff9eb5 0%, #d4a5ff 50%, #a0cfff 100%)",
        "anime-bg-glow":
      ...
      keyframes: {
        ...
        glow: {
          from: {
            boxShadow: "0 0 5px #ff9eb5, 0 0 10px #ff9eb5, 0 0 15px #ff9eb5",
          },
          to: {
            boxShadow: "0 0 10px #ff9eb5, 0 0 20px #ff9eb5, 0 0 30px #ff9eb5",
          },
        },
        "sakura-fall": {
      ...
      boxShadow: {
        ...
        "neon-pink":
          "0 0 5px #ff9eb5, 0 0 10px #ff9eb5, 0 0 15px #ff9eb5, 0 0 20px #ff9eb5",
        "neon-blue":
          "0 0 5px #a0cfff, 0 0 10px #a0cfff, 0 0 15px #a0cfff, 0 0 20px #a0cfff",
        "neon-purple":
          "0 0 5px #d4a5ff, 0 0 10px #d4a5ff, 0 0 15px #d4a5ff, 0 0 20px #d4a5ff",
      },
      fontFamily: {
