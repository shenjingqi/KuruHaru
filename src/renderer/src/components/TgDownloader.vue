      ...
      <div class="files-section">
        <div class="files-header">
          ...
          <div class="files-stats">
            ...
            <span v-if="useFilter" class="stat skip">将跳过: {{ skipFiles.length }}</span>
            <span class="stat will-download">将下载: {{ downloadFiles.length }}</span>
          </div>
        </div>
        ...
        <div class="files-actions">
          ...
          <button class="action-btn" @click="reloadAndScan">清除缓存并重新扫描</button>
          <button
        ...
        <div class="files-list">
          ...
          >
            ...
            <span v-if="skippedFileIds.has(file.id)" class="skip-badge">跳过</span>
          </div>
        </div>
